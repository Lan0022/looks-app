    ...
    <nav class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-5">
                <a href="{{ route('products') }}" class="text-gray-700 hover:text-accent" title="Browse Products">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                @auth
                    ...
                    <a href="{{ route('profile') }}" class="text-gray-700 hover:text-accent" title="Profile">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('register') }}" class="text-gray-700 hover:text-accent" title="Register">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                ...
                @endauth
                <a href="{{ route('cart') }}" class="text-gray-700 hover:text-accent relative" title="Cart">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
